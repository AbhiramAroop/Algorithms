    ...
    def __setitem__(self, key, item):
        ...
        for i in range(0, self.table_size//2):
            ...
            if self.table[pos] == None:
                ...
                pos = (pos+1)%self.table_size #% self.table_size
...
class Freq:
    ...
    def add_file(self,filename):
        ...
        for line in read_lines: #check each line
            ...
            for word in words: #go through every word in line
                if word in self.words: #word already found before?
        ...
        file.close()
        for i in range(0,len(self.words)): #update self.max
    ...
    def rarity(self,word):
        ...
        """
        no_word = 0
        if word in self.words: #is there such word?
...
#Running 1342, 2600, 98
#Currently in Doc-String format
"""
freq = Freq()
