...
class TestTask4(unittest.TestCase):
  ...
  def test_delete(self):
    ...
    #---------myTestcase------------
    ed.delete_num("1")
    self.assertTrue(equal_lines(ed, test_content[2:]), msg =  "Failed to delete first line.")
    ed.delete_num("1")
    self.assertTrue(equal_lines(ed, test_content[3:]), msg =  "Failed to delete first line.")
    #---------myTestcase------------
