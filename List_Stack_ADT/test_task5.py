...
class TestTask5(unittest.TestCase):
  def test_search(self):
    ...
    #testing of non-strings
    self.assertTrue(ed.search_string(1) == '?',msg = "Incorrect handling of non-strings")
    self.assertTrue(ed.search_string(True) == '?', msg =  "Incorrect result for search query {0}".format(query))
